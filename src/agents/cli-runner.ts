...
export async function runCliAgent(params: {
  ...
  const resolvedCliTarget = resolveCliProviderAndModel({ backend, modelId });
  const normalizedModel = resolvedCliTarget.modelId;
  ...
  const executeCliWithSession = async (
    ...
    const args = buildCliArgs({
      ...
      providerId: resolvedCliTarget.providerId,
